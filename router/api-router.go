...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		// LLMShare: public enabled-models list for the home landing page (no
		// auth — so the iframe can render the real model catalog).
		apiRouter.GET("/models/enabled", controller.PublicEnabledModels)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			{
				optionAdminRoute.GET("/export", controller.ExportOptionsAdmin)
				optionAdminRoute.POST("/import", controller.ImportOptionsAdmin)
			}
		}
