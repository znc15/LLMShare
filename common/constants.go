...
// ---- LLMShare: invitation-code registration ----
// When true, password and OAuth registration both require a valid one-time
// invitation code (generated by an admin). Replaces the removed user-pool cap.
var InviteCodeRegisterEnabled = true
