...
export function OverviewDashboard() {
  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      {showContentPanels && (
        <CardStaggerContainer className='grid grid-cols-1 items-stretch gap-4'>
          {/* Performance/health: full-width banner (was the original layout). */}
          {isAdmin && (
            <CardStaggerItem className='col-span-full'>
              <PerformanceHealthPanel />
            </CardStaggerItem>
          )}
          {/* Three equal-height columns: announcements, FAQ, API info. */}
          {(showAnnouncementsPanel || showFAQPanel || showApiInfoPanel) && (
